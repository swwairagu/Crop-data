...
control_data_filtered <- cotton %>%                             # create a filtered dataset with the controls  
...
```{r shapiro-wilk-IQ}
IQ_data_filtered <- cotton %>%                                  # create a filtered IQ dataset 
...
```{r}
ggplot(cotton, aes(sample = Log.OpenBollWeight,
                        color = Treatment)) +
  geom_qq() +
  geom_qq_line() +
