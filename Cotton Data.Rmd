...
control_data_filtered <- cotton_data %>%
  filter(Treatment == "Control")
shapiro.test(control_data_filtered$Log.OpenBollWeight) 
```

```{r shapiro-wilk-IQ}
# Shapiro-Wilk normality test
IQ_data_filtered <- cotton_data %>%
  filter(Treatment == "IQ")
shapiro.test(IQ_data_filtered$Log.OpenBollWeight)
```
