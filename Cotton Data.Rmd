...
```{r shap-wilk-control-openbollwt}
...
```{r hsit-openbolls, fig.height=5, fig.width=9}
...
```{r shap-wilk-control-bollsperplant}
shapiro.test(control_data_filtered$Log.OpenBollsperPlant) 
```

```{r shap-wilk-IQ-bollsperplant}
