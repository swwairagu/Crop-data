...
```{r Q-Q-control, fig.height=6, fig.width=8}
library(qqplotr)
...
```{r Q-Q-IQ, fig.height=6, fig.width=8}
...
Both of the normal quantile plots show that the log transformed data in both groups are normal.
